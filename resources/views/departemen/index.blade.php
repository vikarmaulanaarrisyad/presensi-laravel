...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-12 col-md-12">
            <x-card>
                <x-slot name="header">
                    <button onclick="addForm(`{{ route('departemen.store') }}`)" class="btn btn-sm btn-info">
    ...
    @include('departemen.import-excel')
@endsection
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Form Departemen') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Form Departemen') {
            Swal.fire({
                title: "Memuat...",
