...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-12 col-md-12">
            <x-card>
                <x-slot name="header">
                    <button onclick="addForm(`{{ route('jamkerja.store') }}`)" class="btn btn-sm btn-info">
...
@push('scripts')
    <script>
        ...
        function addForm(url, title = 'Form Jam Masuk & Pulang') {
            $(modal).modal('show');
        ...
        function editForm(url, title = 'Form Jam Masuk & Pulang') {
            Swal.fire({
                title: "Memuat...",
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            jamMasukInput.addEventListener('change', function() {
                ...
                // Disable jam pulang sebelum jam masuk
                flatpickr(jamPulangInput, {
                    enableTime: true,
                    noCalendar: true,
                    dateFormat: "H:i",
                    time_24hr: true,
                ...
                // Reset jika jam pulang tidak valid
                if (jamPulangInput.value && toMinutes(jamPulangInput.value) <= toMinutes(this.value)) {
                    jamPulangInput.value = '';
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops! Gagal',
                        text: 'Jam pulang harus lebih besar dari jam masuk',
                        showConfirmButton: false,
                        timer: 3000,
                    });
                }
